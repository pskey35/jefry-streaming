    ...
    <ul className="flex items-center flex-shrink-0 space-x-6">
      <li className="text-black flex items-center justify-center">
        ...
        <span
          ...
          style={{ fontWeight: "900", fontSize: "24px", color: "#9333ea" }}
        >
          $ {saldoUser}
        </span>
      </li>
...
function Header() {
  const { setAccessToken } = useRefreshToken(
    null,
    `${import.meta.env.VITE_api}/JWT/api/v1/token/refresh/`
  );
  ...
  return (
    <>
      <header className="z-10 py-4 bg-white shadow-md dark:bg-gray-800 w-full shadow-md shadow-gray-500/30">
        <div
