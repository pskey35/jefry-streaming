                ...
                <ul>
                    ...
                    <li className="relative px-6 py-3">
                        ...
                        >
                            ...
                            <svg
                                className="w-4 h-4 transform rtl:-rotate-90"
                                aria-hidden="true"
                                fill="none"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                        ...
                        <div
                            className={`${pagesMenuOpen ? 'block' : 'hidden'
                                } absolute left-full top-0 w-56 mt-1 space-y-2 bg-white dark:bg-gray-800 shadow-lg rounded-lg`}
                        >
                            <a
