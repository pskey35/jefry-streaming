...
export default function Subscriptions() {
    ...
    return (
        <div className="w-full overflow-x-auto flex bg-gray-50 h-full">
            <Aside />
            <div className="rightContent flex flex-col items-center h-full" style={{width:"calc(100% - 256px)"}}>
                <Header />
                <div className="w-full overflow-hidden 
                rounded-3xl shadow-xs flex-1 flex 
                items-center py-8
                px-4
                 md:px-8 flex-col max-w-[100%] relative
                md:py-8
                overflow-y-auto
                ">
                    ...
                    {existData == false ?
                        <div className="w-full auto rounded-xl border border-gray-200 rounded-md" id="containerTable">
                        ...
                        isLoading ? (
                            ...
                            <div className="w-full auto rounded-xl border border-gray-200 rounded-md " 
